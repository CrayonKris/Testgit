...
<html>
  ...
  $(function(){
  	...
  	location.href="${app}/CartAddServlet?id=${prod.id}&buynum="+buynum;
  	});
  });
  </script>
</head>
...
<%@ include file="/_head.jsp" %>
	<div id="warp">
		...
		<div id="right">
			...
			<div id="right_middle">
				<span id="right_middle_span"></span>
				 EasyMall 价：<span class="price_red"></span>￥${prod.price }<br/>
			            运     费：满 100 免运费<br />
			            服     务：由EasyMall负责发货，并提供售后服务<br />
			            库     存：${prod.pnum }<br/>
			            购买数量：
	            <a href="#" id="delNum" onclick="">-</a>
	            <input id="buyNumInp" name="" type="text" value="1" >
